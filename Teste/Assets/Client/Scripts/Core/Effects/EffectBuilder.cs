...
namespace L5RGame
{
    public static class EffectBuilder
    {
        ...
        public static class Ring
        {
            public static Func<Game, BaseCard, EffectProperties, Effect> Static(string type, object value)
            {
                return (game, source, props) => new RingTargetEffect(game, source, props, new StaticEffect(type, value));
            }

            public static Func<Game, BaseCard, EffectProperties, Effect> Dynamic(string type, Func<object, AbilityContext, object> value)
            {
                return (game, source, props) => new RingTargetEffect(game, source, props, new DynamicEffect(type, value));
            }

            public static Func<Game, BaseCard, EffectProperties, Effect> Detached(string type, DetachedValue value)
            {
                return (game, source, props) => new RingTargetEffect(game, source, props, new DetachedEffect(type, value.Apply, value.Unapply));
            }
